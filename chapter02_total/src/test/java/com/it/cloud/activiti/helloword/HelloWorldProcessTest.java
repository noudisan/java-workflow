package com.it.cloud.activiti.helloword;
...
public class HelloWorldProcessTest {
    ...
    public void queryHistoryTask(){
        HistoricTaskInstance instance = historyService.createHistoricTaskInstanceQuery().taskId("2505").singleResult();
            System.out.println("历史ID:" + instance.getId());
