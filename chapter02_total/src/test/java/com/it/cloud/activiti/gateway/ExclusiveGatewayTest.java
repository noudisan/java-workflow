...
public class ExclusiveGatewayTest {
    ...
    public void deploy() {
        Deployment deployment = repositoryService.createDeployment() // 创建部署
                .addClasspathResource("diagrams/exclusiveGateway.bpmn20.xml") // 加载流程资源文件
                .name("exclusiveGateway流程") // 流程名称
                .deploy(); // 部署
    ...
    @Test
    public void start() {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("exclusiveGateway"); // 流程定义表的KEY字段值
