...
public class MultiInstanceRejectTaskTest {
    ...
    public void deploy() {
        Deployment deployment = repositoryService.createDeployment() // 创建部署
                .addClasspathResource("diagrams/multiInstance-reject.bpmn20.xml") // 加载流程资源文件
                .name("multiInstance-reject流程") // 流程名称
                .deploy(); // 部署
    ...
    @Test
    public void start() {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("multiInstance-reject"); // 流程定义表的KEY字段值
    ...
    public void completeTask2() {
        ...
        taskService.complete("52505", variables);
    }
